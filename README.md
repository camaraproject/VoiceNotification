<a href="https://github.com/camaraproject/VoiceNotification/commits/" title="Last Commit"><img src="https://img.shields.io/github/last-commit/camaraproject/VoiceNotification?style=plastic"></a>
...
* The API(s) provide(s) the API consumer with the ability to:  
  This capability provides users with voice notification services, mainly applied in multiple scenarios such as meeting notifications, express delivery notifications, and online education
...
* Meetings are held virtually 
    ...
    * Minutes: Access [Meeting minutes](https://lf-camaraproject.atlassian.net/wiki/spaces/CAM/pages/119275592/Minutes+-+VoiceNotification)
* Mailing List
